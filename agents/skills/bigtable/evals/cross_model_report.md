...
|-------|-------------------|----------------------|-------------|
| **Gemini CLI (Generalist)** | 50.0% | 80.0% | **+30.0%** |
...
The Bigtable Skill is currently optimized for **Gemini CLI**, particularly in how it links to reference documents. To truly support cross-model evaluation, future iterations should:
