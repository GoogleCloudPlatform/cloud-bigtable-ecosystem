...
var mockTableSchemaConfig = schemaMapping.NewSchemaMappingConfig(
	...
	[]*schemaMapping.TableConfig{
		schemaMapping.NewTableConfig(
			...
			[]*types.Column{
				{Name: "test_id", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_PARTITION, IsPrimaryKey: true},
				{Name: "column1", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_CLUSTERING, IsPrimaryKey: true, PkPrecedence: 1},
				{Name: "column10", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_CLUSTERING, IsPrimaryKey: true, PkPrecedence: 2},
				{Name: "test_hash", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_REGULAR},
				{Name: "column2", CQLType: types.TypeBlob, KeyType: u.KEY_TYPE_REGULAR},
				{Name: "column3", CQLType: types.TypeBoolean, KeyType: u.KEY_TYPE_REGULAR},
			},
		),
		schemaMapping.NewTableConfig(
			"keyspace",
			...
			types.OrderedCodeEncoding,
			[]*types.Column{
				{Name: "name", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_PARTITION, IsPrimaryKey: true, PkPrecedence: 0},
				{Name: "age", CQLType: types.TypeVarchar, KeyType: u.KEY_TYPE_REGULAR},
			},
		),
	},
)
