...
public class BigtableSchemaManagerTest {
  ...
  //   Collection<MutationData> input =
  //       generateInput(
  //           tables.stream()
  //               .map(l -> new AbstractMap.SimpleImmutableEntry<>(l, Set.of("cf")))
  //               .collect(Collectors.toList()));
  //   var errors = bigtableSchemaManager.ensureTablesExist(input);
  ...
  //               new AbstractMap.SimpleImmutableEntry<>(tables.get(1), Set.of("missingCF"))));
  //   var errors = bigtableSchemaManager.ensureTablesExist(ensureTablesExistInput);
  //   assertTrue(errors.isEmpty());
  ...
  //   verifyNoInteractions(bigtable);
  //
  //   var ensureColumnFamiliesExistInput =
  //       generateInput(new ArrayList<>(tablesAndColumnFamilies.entrySet()));
  //   var errors =
  ...
  // }
  //
  // private static Collection<MutationData> generateInput(
  //     List<Map.Entry<String, Set<String>>> records) {
  //   int uniqueKafkaOffset = 1;
  //   List<MutationData> result = new ArrayList<>();
  ...
  //     MutationData mutationData = spoofSinkRecordOutput(sinkRecord, record.getKey(), record.getValue());
  //     result.add(mutationData);
  //   }
  //   return result;
  // }
  //
  ...
  //     SinkRecord sinkRecord, String targetTable, Set<String> columnFamilies) {
  //   return new MutationData(TableId.of(targetTable), sinkRecord, null, null, columnFamilies);
  // }
  //
